    ...
    component: () => (
      <div className={`h-full flex flex-col items-center justify-center text-center bg-gradient-to-br ${currentLesson.gradient}`}>
        <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.5 }}>
          <span className="text-9xl md:text-[12rem] mb-8 block drop-shadow-lg filter">{currentLesson.icon}</span>
          <h1 className="text-6xl md:text-9xl font-black text-white mb-6 drop-shadow-xl">{currentLesson.title.split(' ')[0]}</h1>
          <h2 className="text-3xl md:text-6xl font-light text-white mb-10">{currentLesson.title.substring(5)}</h2>
    ...
    commonSlides.push(
      {
        ...
        component: () => (
          <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 transition-colors duration-500">
             <h2 className="text-5xl md:text-6xl font-bold mb-16 text-gray-800 dark:text-white">Imagine the taste...</h2>
             <div className="flex gap-12 md:gap-24">
                {[{emoji: "🍋", label: "Lemon", color: "text-yellow-500 dark:text-yellow-400"}, {emoji: "🌶️", label: "Chili", color: "text-red-600 dark:text-red-500"}, {emoji: "🍫", label: "99% Cocoa", color: "text-gray-700 dark:text-neutral-500"}].map((item, idx) => (
                  ...
                  >
                    <div className="text-8xl md:text-[10rem] mb-8 transform group-hover:scale-110 transition-transform cursor-pointer drop-shadow-md">{item.emoji}</div>
                    <p className={`text-3xl md:text-4xl font-bold ${item.color}`}>{item.label}</p>
                  </motion.div>
                ))}
             </div>
             <p className="mt-16 text-2xl text-gray-500 dark:text-neutral-400">Show me the face you make!</p>
          </div>
        )
      },
      {
        ...
        component: () => (
          <div className="h-full flex flex-col md:flex-row items-center justify-center gap-16 bg-gray-50 dark:bg-neutral-900 p-8 transition-colors duration-500">
            ...
            <div className="w-full md:w-1/2 space-y-6">
              <h3 className="text-4xl md:text-5xl font-bold text-orange-500 mb-8">Categorize These Words</h3>
              <div className="grid grid-cols-2 gap-6">
                {['Baked (Method)', 'Savory (Taste)', 'Crunchy (Texture)', 'Bland (Taste)', 'Stew (Method)', 'Spicy (Taste)'].map((word, i) => (
                  <motion.div 
                    ...
                    className="bg-white dark:bg-neutral-800 p-6 rounded-xl border border-gray-200 dark:border-neutral-700 hover:border-orange-500 dark:hover:border-orange-500 text-gray-800 dark:text-gray-200 shadow-sm transition-colors text-xl font-medium"
                  >
           ...
           <div className="h-full flex items-center justify-center bg-gray-50 dark:bg-neutral-900 p-8 transition-colors duration-500">
             <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-8">
                  <h2 className="text-5xl md:text-6xl font-bold text-orange-500">Supertasters</h2>
      ...
      },
      {
        ...
        component: () => (
           <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 p-4 transition-colors duration-500">
             <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-12">Let's Talk Taste</h2>
             <div className="scale-110 w-full flex justify-center">
     ...
     commonSlides.push(
      {
        ...
        component: () => (
          <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 transition-colors duration-500 p-8">
             <h2 className="text-4xl md:text-5xl mb-12 font-light text-gray-800 dark:text-white">What container is it?</h2>
             <div className="w-full max-w-7xl grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
               {[
                 ...
                 {img: "https://images.unsplash.com/photo-1601618213601-5232773b063d?auto=format&fit=crop&q=80&w=800", label: "Tube", bg: "bg-green-900/10 dark:bg-green-900/20"}
                  ...
                  <motion.div 
                    ...
                    className={`p-6 rounded-2xl border border-gray-200 dark:border-white/10 ${item.bg} flex flex-col items-center shadow-md`}
                  >
                    <div className="w-full h-64 rounded-xl bg-cover bg-center mb-6 shadow-xl" style={{ backgroundImage: `url(${item.img})`}}></div>
                    <span className="font-bold text-2xl text-gray-800 dark:text-gray-100">{item.label}</span>
                  </motion.div>
               ))}
             </div>
          </div>
      ...
      },
      {
         ...
         component: () => (
           <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 p-8 transition-colors duration-500">
             <div className="max-w-6xl text-center scale-110">
               <h2 className="text-5xl font-bold mb-8 text-purple-600 dark:text-purple-400">The Innovation Pitch</h2>
               <p className="text-2xl text-gray-700 dark:text-gray-300 mb-12">You have invented a crazy new product (e.g. Spaghetti-in-a-Tube). <br/>Explain the production line to the investors.</p>
               <FlowChart />
             </div>
           </div>
         )
      },
      {
         ...
         component: () => (
           <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 p-8 transition-colors duration-500">
              <h2 className="text-5xl font-bold mb-8 text-purple-600 dark:text-purple-400">The Passive Voice</h2>
              <p className="text-2xl text-gray-600 dark:text-gray-400 mb-16">Shift the focus from the <span className="text-blue-500 dark:text-blue-400">person</span> to the <span className="text-red-500 dark:text-red-400">object</span>.</p>
              <div className="scale-125 origin-center">
                <PassiveActiveToggle />
              </div>
              <div className="mt-16 text-xl font-mono bg-gray-200 dark:bg-black/50 p-6 rounded-lg text-purple-800 dark:text-purple-200 border border-purple-200 dark:border-purple-900">
      ...
      },
      {
        ...
        component: () => (
           <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 p-4 transition-colors duration-500">
             <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-12">Production & Process</h2>
             <div className="scale-110 w-full flex justify-center">
    ...
    commonSlides.push(
      {
        ...
        component: () => (
           <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 transition-colors duration-500">
              <div className="scale-150 transform mb-12">
                 <WasteChart />
              </div>
              <p className="mt-12 text-4xl max-w-4xl text-center text-gray-700 dark:text-gray-300 font-light leading-snug">
             ...
             <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <div className="relative h-[600px] w-full">
                  ...
                  <div className="absolute bottom-10 left-10 text-white">
                     <h3 className="text-4xl font-bold mb-2">The Ugly Truth</h3>
                     <p className="text-xl">Page 84</p>
                  </div>
                </div>
                <div className="space-y-8">
                   <h3 className="text-4xl font-bold text-teal-600 dark:text-teal-500">Comprehension Check</h3>
                   <ul className="space-y-6 text-2xl text-gray-800 dark:text-gray-200">
                     {[
      ...
      },
      {
        ...
        component: () => (
           <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 p-4 transition-colors duration-500">
             <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-12">Environment & Habits</h2>
             <div className="scale-110 w-full flex justify-center">
    ...
    commonSlides.push(
      {
        ...
        component: () => (
          <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 transition-colors duration-500 p-8">
             <div className="relative w-full max-w-7xl h-[600px] overflow-hidden rounded-3xl shadow-2xl border-4 border-white dark:border-neutral-700">
               ...
               <div className="absolute inset-0 bg-red-900/30 flex items-center justify-center pointer-events-none">
                  <h2 className="text-8xl md:text-9xl font-black text-white border-8 border-white p-8 transform -rotate-12 uppercase tracking-widest drop-shadow-2xl">Disaster!</h2>
               </div>
             </div>
             <div className="flex flex-wrap gap-6 mt-12 justify-center">
               {["Too Salty", "Rude Waiter", "Found a Hair", "Overcharged", "Cold Soup"].map((tag, i) => (
                  <span key={i} className="px-8 py-4 bg-white dark:bg-neutral-800 rounded-full text-red-500 dark:text-red-400 font-bold text-2xl border border-red-200 dark:border-red-900/50 shadow-lg">{tag}</span>
               ))}
             </div>
          </div>
        )
      },
      {
        ...
        component: () => (
          <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 p-8 transition-colors duration-500">
            <h2 className="text-4xl md:text-5xl font-bold mb-16 text-gray-900 dark:text-white">The Complaint Roleplay</h2>
            <div className="flex flex-col md:flex-row gap-12 w-full max-w-6xl justify-center">
               <div className="w-full md:w-1/2 scale-110">
                 <RoleplayCard 
      ...
      },
      {
        ...
        component: () => (
          <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 p-8 transition-colors duration-500">
             <h2 className="text-4xl md:text-5xl font-bold mb-8 text-red-600 dark:text-red-500">Complaining Politely</h2>
             <p className="text-2xl text-gray-600 dark:text-gray-400 mb-16">Don't be rude. Use "softeners".</p>
             <div className="scale-125 w-full max-w-4xl">
               <PolitenessScale />
             </div>
          </div>
        )
      },
      {
        ...
        component: () => (
          <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 p-8 transition-colors duration-500">
            ...
            <div className="mt-16 bg-white dark:bg-neutral-800 p-6 rounded-xl text-2xl text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-neutral-700 shadow-sm">
      ...
      },
      {
        ...
        component: () => (
           <div className="h-full flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 p-4 transition-colors duration-500">
             <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-12">Roleplay Scenarios</h2>
             <div className="scale-110 w-full flex justify-center">
      ...
      <div className="relative w-full h-full bg-white dark:bg-neutral-950 text-gray-900 dark:text-neutral-100 transition-colors duration-500">
        ...
        {appMode === 'game' ? (
          ...
          <div className="relative w-full h-full flex flex-col">
            ...
            {/* Header */}
            <header className="absolute top-2 left-0 w-full p-8 flex justify-between items-center z-20">
            ...
            <AnimatePresence>
              {userMode === 'teacher' && slides[currentSlideIndex].teacherNotes && (
                <motion.div 
                  ...
                  className="absolute bottom-28 left-1/2 transform -translate-x-1/2 w-full max-w-4xl z-30 px-4"
                >
                  <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 backdrop-blur-md rounded-2xl p-6 shadow-2xl">
            ...
            {currentLessonId !== 5 && (
              <div className="absolute bottom-10 right-10 flex gap-6 z-20">
                <button 
                  onClick={prevSlide}
                  disabled={currentSlideIndex === 0}
                  className="p-6 rounded-full bg-black/5 dark:bg-white/5 backdrop-blur-md border border-black/10 dark:border-white/10 hover:bg-black/10 dark:hover:bg-white/20 disabled:opacity-30 disabled:cursor-not-allowed transition-all text-gray-900 dark:text-white"
                >
                  <ChevronLeft size={32} />
                </button>
                <button 
                  ...
                  className={`p-6 rounded-full text-white shadow-2xl transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:grayscale bg-gradient-to-r ${currentLesson.gradient}`}
                >
